...
export default function TreeSidebar({
  ...
  return (
    <div className="relative flex h-full">
      <button
        onClick={onToggle}
        className="absolute top-2 -left-10 z-10 flex h-8 w-8 items-center justify-center rounded-md border bg-card text-muted-foreground hover:text-foreground hover:bg-accent transition-colors"
